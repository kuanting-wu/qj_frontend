  ...
  <div class="flex flex-wrap gap-10 px-20 py-8 bg-white">
    ...
    >
      <div class="flex flex-col justify-center w-auto">
        ...
        <div class="flex flex-col mt-2 w-full">
          <label for="sequenceStartTime" class="leading-6"
        ...
        <div class="flex flex-col mt-2 w-full whitespace-nowrap">
          <label for="status" class="leading-snug">Status</label>
          <input
            id="status"
            type="text"
            class="overflow-hidden flex-1 shrink self-stretch px-4 py-3 mt-1 w-full leading-none bg-white rounded-lg border border-solid border-zinc-300"
            aria-label="Status"
          />
        </div>
        <div class="flex flex-col mt-2 w-full whitespace-nowrap">
          <label for="language" class="leading-6">Language</label>
          <input
            id="language"
            type="text"
            class="overflow-hidden flex-1 shrink self-stretch px-4 py-3 mt-1 w-full leading-none bg-white rounded-lg border border-solid border-zinc-300"
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              class="flex overflow-hidden flex-1 shrink gap-2 items-center self-stretch px-4 py-3 my-auto w-full bg-white rounded-full border border-solid basis-0 border-zinc-300 min-w-[240px]"
            >
              <label for="searchInput" class="sr-only">Search</label>
              <input
                id="searchInput"
                type="search"
                class="flex-1 shrink self-stretch my-auto basis-0 outline-none"
                placeholder="Search"
                aria-label="Search"
              />
              <img
        ...
        >
          <button
            class="flex gap-2 justify-center items-center p-2 whitespace-nowrap rounded-lg bg-zinc-800 text-neutral-100"
          >
            <img
              loading="lazy"
              ...
              class="object-contain shrink-0 self-stretch my-auto w-4 text-white aspect-square"
              alt=""
            />
            <span class="self-stretch my-auto text-neutral-100">New</span>
          </button>
